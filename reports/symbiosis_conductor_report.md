...
- Generated: **2025-12-22T08:29:34Z**
- Repo root: `/home/ales27pm/offLLM-1`
- Repo fingerprint: `git:50ac34363ca4cccadd102330f6901282d3163d53`
...
- **eval/export_equivalence.py** — score=41.3, churn=2, reasons=appears_in_surfaces=['evaluation', 'hot_churn', 'telemetry']; git_churn_commits~2
- **eval/retrieval_eval.py** — score=41.3, churn=2, reasons=appears_in_surfaces=['hot_churn', 'retrieval_rag', 'telemetry']; git_churn_commits~2
...
- **eval/golden_prompts.json** — score=38.0, churn=1, reasons=appears_in_surfaces=['prompts', 'tools_orchestration']; sarif_findings=1; git_churn_commits~1
- **eval/run_prompt_regression.py** — score=36.0, churn=4, reasons=appears_in_surfaces=['evaluation', 'hot_churn']; git_churn_commits~4
- **AGENTS.md** — score=31.3, churn=2, reasons=appears_in_surfaces=['hot_churn', 'ios_mlx_coreml']; git_churn_commits~2
