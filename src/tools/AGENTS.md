...
- Extend `toolHandler.test.js` whenever you add new tool commands or parser capabilities so malformed arguments and error handling remain covered by CI.【F:**tests**/toolHandler.test.js†L1-L76】
