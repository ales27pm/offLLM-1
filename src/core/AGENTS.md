...
- Update or extend the relevant Jest suites whenever you adjust prompt formatting, tool parsing, or memory behaviour. `toolHandler.test.js`, `workflowTracer.test.js`, and `vectorMemory.test.js` currently lock in the observable contracts for these modules.【F:**tests**/toolHandler.test.js†L1-L76】【F:**tests**/workflowTracer.test.js†L1-L40】【F:**tests**/vectorMemory.test.js†L1-L45】
